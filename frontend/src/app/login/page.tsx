...
export default function LoginPage() {
  ...
  const handleGuestLogin = async () => {
    ...
    try {
      ...
      // Store in Zustand (and it should persist to localStorage)
      ...
      <div className="w-full max-w-sm">
        <div className="flex justify-center mb-8">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-lg">Pyram...</span>
          </div>
        </div>
        ...
        <p className="text-center text-xs text-gray-500 dark:text-gray-400 mt-6 px-8">
          By clicking continue, you agree to our{" "}
          <a href="#" className="underline hover:text-gray-800 dark:hover:text-gray-200">Terms of Service</a>{" "}
          and{" "}
          <a href="#" className="underline hover:text-gray-800 dark:hover:text-gray-200">Privacy Policy</a>
        </p>
      </div>
    </div>
  );
