...
# Project Memory — task-management
...
**Stack:** JavaScript/TypeScript · NestJS + Next.js + React + Tailwind · DB: Prisma
...
- Handle exceptions with ExceptionFilters, not try/catch in controllers
- Use Guards for authentication, not middleware
- Use DTOs with class-validator for ALL endpoint inputs
